...
lr.fit(cleaned_X_train.values,cleaned_y_train.values.ravel())
...
# predict
predictions = lr.predict(cleaned_X_test.values)
...
cm = confusion_matrix(cleaned_y_test, predictions)
print("\nConfusion matrix:")
print(cm)

cr = classification_report(cleaned_y_test, predictions)
